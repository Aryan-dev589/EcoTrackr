...
function Login() {
  ...
  const handleSubmit = (e) => {
    e.preventDefault();
    // Here you would handle login logic, then redirect:
    navigate('/dashboard');
  };
  return (
    <div className="min-h-screen flex items-center justify-center bg-gradient-to-br from-green-50 via-green-100 to-emerald-50 py-12 px-4">
      ...
      >
        <h2 className="text-3xl font-bold text-green-700 mb-6 text-center flex items-center gap-2 justify-center"><i className="fas fa-sign-in-alt"></i> Login</h2>
